        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <Link to="/" className="text-2xl font-bold tracking-tight hover:text-[#FFD100]">
                Campus Life VU
              </Link>
            </div>
            ...
            {user ? (
              <div className="flex items-center space-x-6">
                <Link to="/" className="text-white hover:text-[#FFD100] transition text-lg">
                  Home
                </Link>
                <Link to="/library" className="text-white hover:text-[#FFD100] transition text-lg">
                  Library
                </Link>
                <Link to="/confessions" className="text-white hover:text-[#FFD100] transition text-lg">
                  Confessions
                </Link>
                <Link to="/polls" className="text-white hover:text-[#FFD100] transition text-lg">
                  Polls
                </Link>
                <Link to="/events" className="text-white hover:text-[#FFD100] transition text-lg">
                  Events
                </Link>
                ...
                <button 
                  ...
                  className="bg-[#FFD100] text-[#0033A0] px-4 py-2 rounded-full hover:bg-yellow-400 transition font-semibold text-sm shadow"
                >
                  Logout
                </button>
              </div>
            ...
            user ? <Feed user={user} profile={profile} /> : (
              <div className="text-center py-12 bg-white rounded-2xl shadow-sm p-8 max-w-4xl w-full">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">
                  Welcome to <span className="text-[#0033A0]">Campus Life VU</span>
                </h2>
                <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                  The social platform built for Victoria University students
                </p>
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                  <div className="bg-gray-50 p-6 rounded-xl">
                    <div className="text-4xl mb-3">📱</div>
                    <h3 className="font-bold text-lg mb-2">Connect</h3>
                    <p className="text-gray-600">Chat with students across all faculties</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-xl">
                    <div className="text-4xl mb-3">📚</div>
                    <h3 className="font-bold text-lg mb-2">Study</h3>
                    <p className="text-gray-600">Form study groups and share notes</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-xl">
                    <div className="text-4xl mb-3">🎉</div>
                    <h3 className="font-bold text-lg mb-2">Socialize</h3>
                    <p className="text-gray-600">Discover campus events and parties</p>
                  </div>
                </div>
                <button 
                  onClick={() => window.location.href = '/signup'}
                  className="bg-[#0033A0] text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-[#002277] transition shadow-lg"
                >
                  Join Now
                </button>
              </div>
